...
from scripts.pairwise_selection.pairwise_hf_false_justification import elicit_fj_for_split
...
image = (
    ...
    .add_local_python_source("scripts.pairwise_selection.pairwise_hf")  # needed for imported functions
    .add_local_python_source("scripts.pairwise_selection.pairwise_hf_false_justification")  # adjust filename as needed
)
