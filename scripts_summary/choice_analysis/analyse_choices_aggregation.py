...
from scripts_summary.choice_analysis.analyse_choices import get_unique_settings, format_setting_name
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python -m scripts_summary.choice_analysis.scripts_summary.choice_analysis.analyse_choices_aggregation /path/to/config.yaml <partial_run_name>")
        sys.exit(1)
